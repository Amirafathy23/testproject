        ...
        <td className="px-6 py-4">
          <form className="max-w-xs mx-auto">
            ...
            <div className="relative flex items-center">
              ...
              <span id="counter-input-1" data-input-counter className="shrink-0 text-heading mx-3 border-0 bg-transparent text-sm font-normal focus:outline-none focus:ring-0 max-w-[2.5rem] text-center"   >{prod.count}</span>
