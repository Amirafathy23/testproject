...
import imgLogo from '../../../aassets/images/freshcart-logo.svg'
import Image from 'next/image'
import { signOut, useSession } from 'next-auth/react'
import { Badge } from 'lucide-react'
import { DropdownMenuBasic } from '../dropDown/DropDown'
import { useQuery } from '@tanstack/react-query'
import { CartResponse } from './../../types/cart-resonse';
...
<nav className="bg-gray-200 py-2 ">
  <div className="max-w-screen-xl flex flex-wrap md:flex-nowrap md:gap-16 items-center justify-between mx-auto p-4">
    ...
    <Image width={150} height={100} src={imgLogo} alt="logo" />
    </a>
...
<li className='relative'>
  <span className=' w-[25px] h-[25px] flex justify-center items-center absolute start-3 -top-[23px] bg-green-400 text-white  rounded-full '>{cartData?.numOfCartItems}</span>
